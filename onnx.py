...
class YOLOv8:
    ...
    def preprocess(self, img):
        ...
        return cv2.dnn.blobFromImage(img, scalefactor=1 / 255, size=(640, 640), swapRB=True)
    ...
    def detect(self, img):
        ...
        start = time.time()
        ret, detections = self.postprocess(self.img, outputs)  # output image
        stop = time.time()
        diffs.append(stop - start)
        return ret, detections, diffs
